...
i686-elf-gcc -c x86/cpu.c -o x86/cpu.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I./include
i686-elf-gcc -c x86/interrupts.c -o x86/interrupts.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I./include

i686-elf-gcc -T linker.ld -o os.bin -ffreestanding -O2 -nostdlib boot.o kernel.o drivers/tty.o libc/string.o drivers/graphics.o libc/math.o libc/printf.o libc/putchar.o panic.o debug.o x86/pic.c sys/power.o x86/halt.o x86/interrupts.o x86/cpu.o -lgcc
